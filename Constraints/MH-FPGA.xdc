...
# set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports {vga_r[3]}];
...
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {MOSI}];
set_property -dict {PACKAGE_PIN R10 IOSTANDARD LVCMOS33} [get_ports {MISO}];
